 ...
 * USA
 */
package com.lrscp.FileBackupTool.third;
...
/**
 * Simple implementation of a cache, using Least Recently Used algorithm for
 * discarding members when the cache fills up
 */
public class LRUCache {
    ...
    /**
     * Puts a new object in the cache. If the cache is full, it removes the
     * least recently used object. The new object becomes the most recently used
     * object.
     */
    public void put(Object key, Object value) {
        ...
        synchronized (this) {
            ...
            if (cacheValue != null) {
                if (cacheValue != value) removed.add(cacheValue);
    ...
    /**
     * Gets an object from the cache. This object is set to be the most recenty
     * used
     */
    ...
    /**
     * Override this method to do special cleanup on an object, such as closing
     * a statement or a connection
     */
